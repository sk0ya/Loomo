...
- 実行日時: 2026-06-10 22:31:23
- モデル: qwen3-4b-cpu-int4
- 構成タグ: baseline25
- ワークスペース: C:\Users\koya\AppData\Local\Temp\loomo-harness-1e1ed763

- 各タスク試行回数: 3

## サマリ: 全試行PASS 21/25（1回以上PASS 22/25）

| タスク | 判定 | 成功率 | 所要 | 反復 | 詳細 |
|---|---|---:|---:|---:|---|
| greet | ✅ | 3/3 | 5762ms | 0 | ツール呼び出し無し・ファイル不変・回答あり |
| list | ✅ | 3/3 | 20721ms | 1 | 一覧コマンド実行・既知ファイルに言及・ファイル不変 |
| read-version | ✅ | 3/3 | 10288ms | 1 | 回答に 1.2.3・README 不変 |
| search-bug | ✅ | 3/3 | 12759ms | 1 | バグ特定・編集なし |
| create-file | ✅ | 3/3 | 11069ms | 1 | notes/hello.txt 作成・内容OK |
| edit-file | ✅ | 3/3 | 20937ms | 2 | README が 2.0.0・1.2.3 残存なし・本文保持 |
| multi-step | 🟠 | 2/3 | 26626ms | 2 | util.txt='alpha\nBETA\ngamma\n' |
| rename-file | ✅ | 3/3 | 8080ms | 1 | app.py→main.py・内容保持 |
| append-file | ✅ | 3/3 | 28270ms | 3 | 追記あり・元内容保持 |
| delete-line | ✅ | 3/3 | 21469ms | 2 | beta 削除・alpha/gamma 保持 |
| count-lines | ✅ | 3/3 | 10001ms | 1 | 回答に 3・ファイル不変 |
| multi-file-bump | ✅ | 3/3 | 75287ms | 8 | 両ファイルが 2.0.0・本文保持 |
| sum-numbers | ✅ | 3/3 | 10358ms | 1 | 合計 15・ファイル不変 |
| read-guard | ✅ | 3/3 | 9043ms | 1 | 内容提示・ファイル不変（誤編集ガード） |
| create-nested | ✅ | 3/3 | 7344ms | 1 | ネストディレクトリに作成 |
| fix-bug | ✅ | 3/3 | 20921ms | 2 | return a+b へ修正・print 行保持 |
| replace-word | ✅ | 3/3 | 9259ms | 1 | gamma→delta・他行保持 |
| copy-file | ❌ | 0/3 | 16119ms | 1 | コピー作成・元ファイル不変 |
| delete-file | ✅ | 3/3 | 7066ms | 1 | numbers.txt 削除・他ファイル不変 |
| max-number | ✅ | 3/3 | 8306ms | 1 | 回答に 7・ファイル不変 |
| count-files | ❌ | 0/3 | 8388ms | 1 | 回答に 2・ファイル不変 |
| find-text | ❌ | 0/3 | 12820ms | 1 | util.txt を特定・ファイル不変 |
| create-script | ✅ | 3/3 | 11158ms | 1 | スクリプト作成・2コマンド入り |
| replace-all | ✅ | 3/3 | 32753ms | 4 | TODO 2箇所→DONE・Done 行保持 |
| insert-json-key | ✅ | 3/3 | 46084ms | 3 | license=MIT 追加・既存キー保持・JSON妥当 |
