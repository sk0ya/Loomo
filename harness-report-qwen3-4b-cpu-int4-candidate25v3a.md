...
- 実行日時: 2026-06-11 01:37:35
- モデル: qwen3-4b-cpu-int4
- 構成タグ: candidate25v3a
- ワークスペース: C:\Users\koya\AppData\Local\Temp\loomo-harness-7e23c330

- 各タスク試行回数: 3

## サマリ: 全試行PASS 12/13（1回以上PASS 13/13）

| タスク | 判定 | 成功率 | 所要 | 反復 | 詳細 |
|---|---|---:|---:|---:|---|
| greet | ✅ | 3/3 | 5509ms | 0 | ツール呼び出し無し・ファイル不変・回答あり |
| list | ✅ | 3/3 | 20922ms | 1 | 一覧コマンド実行・既知ファイルに言及・ファイル不変 |
| read-version | ✅ | 3/3 | 9464ms | 1 | 回答に 1.2.3・README 不変 |
| search-bug | ✅ | 3/3 | 12356ms | 1 | バグ特定・編集なし |
| create-file | ✅ | 3/3 | 11294ms | 1 | notes/hello.txt 作成・内容OK |
| edit-file | ✅ | 3/3 | 20875ms | 2 | README が 2.0.0・1.2.3 残存なし・本文保持 |
| multi-step | 🟠 | 2/3 | 28599ms | 2 | util.txt='alpha\nbeta\ngamma\n' |
| rename-file | ✅ | 3/3 | 8195ms | 1 | app.py→main.py・内容保持 |
| append-file | ✅ | 3/3 | 9564ms | 1 | 追記あり・元内容保持 |
| delete-line | ✅ | 3/3 | 16783ms | 2 | beta 削除・alpha/gamma 保持 |
| count-lines | ✅ | 3/3 | 9813ms | 1 | 回答に 3・ファイル不変 |
| multi-file-bump | ✅ | 3/3 | 75695ms | 8 | 両ファイルが 2.0.0・本文保持 |
| sum-numbers | ✅ | 3/3 | 10540ms | 1 | 合計 15・ファイル不変 |
