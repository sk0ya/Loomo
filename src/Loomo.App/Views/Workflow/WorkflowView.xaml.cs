...
public partial class WorkflowView : UserControl
{
    ...
    private void OnLogScrollChanged(object sender, ScrollChangedEventArgs e)
    {
        ...
        {
            _logAtBottom = DebugOutputCollectionUpdater.IsAtBottom(
    ...
    private void ResetProgressRows()
    {
        ...
        var layout = WorkflowProgressLayoutPolicy.Resolve(
            hasFinalOutput,
            isProgressVisible,
            isWarmingUp,
            showProgressDetails,
            ProgressAreaRow.Height);

        if (layout.ShouldUpdateProgressAreaHeight)
            ProgressAreaRow.Height = layout.ProgressAreaHeight;
        ProgressAreaRow.MinHeight = layout.ProgressAreaMinHeight;
        ProgressLogRow.MinHeight = layout.ProgressLogMinHeight;
        ProgressLogRow.Height = layout.ProgressLogHeight;
        FinalOutputRow.Height = layout.FinalOutputHeight;
    }
}
