...
/// <summary>IDE ペイン「問題」タブの集約。各エディタタブの LSP マネージャ（<see cref="IEditorLspManager"/>、
...
/// <see cref="ViewModels.ProblemsViewModel"/>（<c>DebugViewModel.Problems</c>）へ渡す。ViewModel 側は
/// 表示用データを持つだけで Editor.Controls には触れない（デバッグ連携の ShellWindow.Debug.cs と同じ
/// 「Viewが橋渡し」の流儀）。</summary>
public partial class ShellWindow
{
    ...
    private void RefreshProblems()
    {
        ...
        _vm.Debug.Problems.ReplaceItems(items);
    }
