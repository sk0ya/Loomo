...
public interface IContextWindowPolicy
{
    ...
    /// </summary>
    Conversation Fit(Conversation conversation, AgentProfile? profile = null);
}
...
public sealed class NoopContextWindowPolicy : IContextWindowPolicy
{
    ...
    public Conversation Fit(Conversation conversation, AgentProfile? profile = null) => conversation;
}
