...
- 実行日時: 2026-06-11 01:14:53
- モデル: qwen3-4b-cpu-int4
- 構成タグ: candidate25v2b
- ワークスペース: C:\Users\koya\AppData\Local\Temp\loomo-harness-6ec73122

- 各タスク試行回数: 3

## サマリ: 全試行PASS 7/12（1回以上PASS 8/12）

| タスク | 判定 | 成功率 | 所要 | 反復 | 詳細 |
|---|---|---:|---:|---:|---|
| read-guard | ✅ | 3/3 | 8611ms | 1 | 内容提示・ファイル不変（誤編集ガード） |
| create-nested | ✅ | 3/3 | 10268ms | 1 | ネストディレクトリに作成 |
| fix-bug | ✅ | 3/3 | 24063ms | 2 | return a+b へ修正・print 行保持 |
| replace-word | ✅ | 3/3 | 9246ms | 1 | gamma→delta・他行保持 |
| copy-file | ❌ | 0/3 | 27469ms | 1 | コピー作成・元ファイル不変 |
| delete-file | ✅ | 3/3 | 7167ms | 1 | numbers.txt 削除・他ファイル不変 |
| max-number | ✅ | 3/3 | 8464ms | 1 | 回答に 7・ファイル不変 |
| count-files | ❌ | 0/3 | 79771ms | 1 | 回答に 2・ファイル不変 |
| find-text | ❌ | 0/3 | 34088ms | 1 | util.txt のみ特定・ファイル不変 |
| create-script | ✅ | 3/3 | 11012ms | 1 | スクリプト作成・2コマンド入り |
| replace-all | ❌ | 0/3 | 34124ms | 5 | TODO 2箇所→DONE・Done 行保持 |
| insert-json-key | 🟠 | 1/3 | 85623ms | 6 | license=MIT 追加・既存キー保持・JSON妥当 |
